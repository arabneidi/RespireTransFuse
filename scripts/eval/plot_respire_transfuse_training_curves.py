...
SAVE_PATH = RUN_DIR / "respire_transfuse_training_validation_calibration.png"
...
figure.suptitle(
    "RespireTransFuse Training, Validation, and Calibration Curves",
